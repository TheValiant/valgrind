/*
 * IDENTIFICATION:
 * stub generated Wed Jul 30 23:16:49 2025
...
#pragma pack(pop)
	...
	kern_return_t RetCode;
	__DeclareRcvRpc(4817, "mach_make_memory_entry")
	__BeforeRcvRpc(4817, "mach_make_memory_entry")
	...
	RetCode = mach_make_memory_entry(In0P->Head.msgh_request_port, &In0P->size, In0P->offset, In0P->permission, &OutP->object_handle.name, In0P->parent_handle.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
	...
	OutP->Head.msgh_size = (mach_msg_size_t)(sizeof(Reply));
	OutP->msgh_body.msgh_descriptor_count = 1;
	__AfterRcvRpc(4817, "mach_make_memory_entry")
}
